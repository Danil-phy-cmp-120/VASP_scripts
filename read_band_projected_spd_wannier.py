...
if xml.converged:
    ...
    for spin in [Spin.up, Spin.down]: 
         ...
         fig, axs = plt.subplots(len(sites), 3)
         ...
         for n in range(len(sites)):
            ...
            for k in range(1, len(bands.kpoints)):
                ...
                for b in range(bands.nb_bands):
                    ...
                    d = bands.projections[spin][b, k, 4, sites[n]] + bands.projections[spin][b, k, 5, sites[n]] + bands.projections[spin][b, k, 6, sites[n]] + bands.projections[spin][b, k, 7, sites[n]] + bands.projections[spin][b, k, 8, sites[n]]

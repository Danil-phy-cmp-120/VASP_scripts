...
for i in range(len(z_atoms)):
    ...
    os.link('DOS/regular/step1/{}/CHGCAR'.format(z_atoms[i]), 'DOS/regular/step2/{}/CHGCAR'.format(z_atoms[i]))

    cell = Structure.from_file('DOS/regular/step1/{}/POSCAR'.format(z_atoms[i]))
    ...
    VaspInput.write_input('DOS/regular/step2/{}'.format(z_atoms[i]))

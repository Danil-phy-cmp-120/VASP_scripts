...
for i in range(len(z_atoms)):
    ...
    if not os.path.isdir('band/regular/step1/{}'.format(z_atoms[i])):
        os.makedirs('band/regular/step1/{}'.format(z_atoms[i]))

    cell = Structure.from_file('{}/ION/regular/{}/FIM1/CONTCAR'.format(os.getcwd(), z_atoms[i]))
    ...
    VaspInput.write_input('band/regular/step1/{}'.format(z_atoms[i]))
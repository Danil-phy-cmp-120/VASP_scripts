...
for i in range(len(names)):
    ...
    for t in np.unique(data_up[:,1]):
        a1, b1, c1 = splrep(data_up[data_up[:,1]==t, 0], data_up[data_up[:,1]==t, num[i]], s=0.0, k=3)
        data_function_1 = BSpline(a1, b1, c1, extrapolate=False)
        a2, b2, c2 = splrep(data_dn[data_dn[:,1]==t, 0], data_dn[data_dn[:,1]==t, num[i]], s=0.0, k=3)
        data_function_2 = BSpline(a2, b2, c2, extrapolate=False)
        a3, b3, c3 = splrep(data_tot[data_tot[:,1]==t, 0], data_tot[data_tot[:,1]==t, num[i]], s=0.0, k=3)
        ...
        if t in T_for_fig:          
            ...
            axs[0].plot(mu_interp- chempot_function(t), data_function_1(mu_interp), color = '#f26430', marker = 'None', markersize = 9, linestyle = '-', linewidth=3, alpha = 0.5, markeredgewidth=1, markerfacecolor = '#f26430', markeredgecolor = '#f26430', label = 'spin-up')
            axs[1].plot(mu_interp- chempot_function(t), data_function_2(mu_interp), color = '#009ddc', marker = 'None', markersize = 9, linestyle = '-', linewidth=3, alpha = 0.5, markeredgewidth=1, markerfacecolor = '#009ddc', markeredgecolor = '#009ddc', label = 'spin-down')
            axs[2].plot(mu_interp- chempot_function(t), data_function_3(mu_interp), color = '#2a2d34', marker = 'None', markersize = 9, linestyle = '-', linewidth=3, alpha = 0.5, markeredgewidth=1, markerfacecolor = '#2a2d34', markeredgecolor = '#2a2d34', label = 'spin-tot')
  
            axs[0].plot([0, 0], [min(data_function_1(mu_interp)), max(data_function_1(mu_interp))], color = '#2a2d34', marker = 'None', markersize = 9, linestyle = '--', linewidth=1, alpha = 1)  
            axs[1].plot([0, 0], [min(data_function_2(mu_interp)), max(data_function_2(mu_interp))], color = '#2a2d34', marker = 'None', markersize = 9, linestyle = '--', linewidth=1, alpha = 1)  
            axs[2].plot([0, 0], [min(data_function_3(mu_interp)), max(data_function_3(mu_interp))], color = '#2a2d34', marker = 'None', markersize = 9, linestyle = '--', linewidth=1, alpha = 1)  
          
            for j in range(3):
                format_ax(axs[j])
        
            fig.savefig('boltzwann_data/from_mu/{}_mu_{}.png'.format(names[i], t), dpi=300, transparent=False, bbox_inches = 'tight')
            plt.close()
    ...
    np.savetxt('boltzwann_data/from_T/{}_T.dat'.format(names[i]), data_t)
    ...
    axs[0].plot(data_t[:,0], data_t[:,1], color = '#f26430', marker = 'o', markersize = 9, linestyle = '-', linewidth=3, alpha = 0.5, markeredgewidth=1, markerfacecolor = '#f26430', markeredgecolor = '#f26430', label = 'spin-up')
    axs[1].plot(data_t[:,0], data_t[:,2], color = '#009ddc', marker = 'o', markersize = 9, linestyle = '-', linewidth=3, alpha = 0.5, markeredgewidth=1, markerfacecolor = '#009ddc', markeredgecolor = '#009ddc', label = 'spin-down')
    axs[2].plot(data_t[:,0], data_t[:,3], color = '#2a2d34', marker = 'o', markersize = 9, linestyle = '-', linewidth=3, alpha = 0.5, markeredgewidth=1, markerfacecolor = '#2a2d34', markeredgecolor = '#2a2d34', label = 'spin-tot')
